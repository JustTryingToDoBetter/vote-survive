...
function StageTimer({ round, secondsLeft }: { round: RoundRecord; secondsLeft: number }) { return <div className={`show-timer ${secondsLeft <= 10 ? "is-urgent" : ""}`}><TimerRing secondsLeft={secondsLeft} duration={getRoundTimerSeconds(round)} /></div>; }
